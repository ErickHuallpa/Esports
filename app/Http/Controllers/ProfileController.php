...
class ProfileController extends Controller
{
    ...
    public function update(Request $request)
    {
        ...
        $request->validate([
            ...
            'foto_perfil' => 'nullable|image|mimes:jpg,jpeg,png,webp|max:2048', // <--- Validación de imagen
        ]);

        // Manejo de la foto de perfil
        if ($request->hasFile('foto_perfil')) {
            // Si el usuario ya tenía una foto, la borramos para no acumular basura en el servidor
